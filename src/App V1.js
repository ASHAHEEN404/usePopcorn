...
export default function App() {
  ...
  // useMovies Hook To Fetch The Movies
...
function SelectedMovie({ selectedId, onCloseMovie, addWatched, watched }) {
  ...
  function handleWatched() {
    const newWatched = {
      ...
      userRating,
      userRatingDesicons: count.current,
    };
  ...
  //   };
  // });
  // Effect For Closing on Escape keypress
  useKey("Escape", onCloseMovie);

  // An Effect for changing page title
  useEffect(
    function () {
      if (!title) return;
          ...
          <section>
            <div className="rating">
              {!isWatched ? (
                ...
                <p> You've rated this movie {watchedUserRating} stars ⭐</p>
              )}
            </div>
            <p>
              <em>{polt}</em>
